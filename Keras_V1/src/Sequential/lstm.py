...
if(not os.path.isfile(filepath)):
    ...
    dummy_model = get_model_classification(actions_len=len(actions), input_shape=input_shape, drop_prob=drop_prob)
...
model = get_model_lstm(actions_len=len(actions), input_shape=input_shape, drop_prob=drop_prob)
